...
Adapted from [hardikpandya/stop-slop](https://github.com/hardikpandya/stop-slop) and [jalaalrd/anti-ai-slop-writing](https://github.com/jalaalrd/anti-ai-slop-writing), both MIT.
...
**Instead:** State Y directly. "The problem is Y." "Y matters here." Drop the negation.
...
| Pattern | Fix |
|---------|-----|
| Wh- openers (What, When, Where, Which, Who, Why, How) | Restructure. Lead with the subject or the verb. |
...
## Rhythm and Parataxis

| Pattern | Fix |
|---------|-----|
| Three-item lists by default | Use two items or four — only three if genuine |
| Questions answered immediately | Let questions breathe or cut them |
| Every paragraph ends punchily | Vary endings |
| Em-dashes | Remove. Use commas or periods. |
| Staccato fragmentation | Don't stack short punchy sentences |
| Three consecutive same-length sentences | Vary them — the single highest-signal AI tell |
| Parataxis (chained short declarative sentences) | Connect with subordinate clauses, conjunctions, semicolons |
...
| All adverbs (-ly, "really," "just," "literally") | Empty emphasis. See [phrases.md](phrases.md). |

## Formatting Tells

- No markdown headers in DMs, emails, casual writing
- No bold random phrases in social media
- No emoji-as-bullet-points (every line starting with ✅ or 🔥 is slop)
- No "🧵" or "Thread:" openers
- No hashtag stacks (zero to two, integrated naturally)
- No markdown in plain-text contexts — asterisks rendering as symbols is an instant tell
